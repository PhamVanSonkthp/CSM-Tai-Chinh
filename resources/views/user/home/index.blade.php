...
@section('content')
    <!-- <h2 class="text-center p-4 fs-1">Thiết bị không phù hợp</h2> -->
                ...
                <header class="header">
                    <div class="container-xl">
                        <div class="header__wrapper">
                            ...
                            <a href="#" class="header-notify" data-bs-toggle="offcanvas" data-bs-target="#headerNotify"
                               aria-controls="headerNotify">
                                <svg viewBox="64 64 896 896" focusable="false" data-icon="bell" width="27" height="27"
                                ...
                                <div class="nav-item">
                                    <a href="#" class="nav-item__icon" data-bs-toggle="offcanvas"
                                       data-bs-target="#offcanvasFile">
                                        <svg viewBox="64 64 896 896" focusable="false" data-icon="file-text" width="1em"
                                ...
                                <div class="nav-item">
                                    <a href="#" class="nav-item__icon" data-bs-toggle="offcanvas"
                                       data-bs-target="#offcanvasInfoBank">
                                        <svg viewBox="64 64 896 896" focusable="false" data-icon="wallet" width="1em"
                                             height="1em" fill="currentColor" aria-hidden="true">
                                            <path
                    ...
                    <div class="container-xl">
                        <div class="footer__wrapper">
                            <div class="footer-img">
                                <img src="https://mafc.com.vn/wp-content/uploads/2021/11/Banner-Mobile-web-3.jpg.webp"
                                     alt="Img">
                            </div>
                ...
                <div class="tabs-account">
                            ...
                            @else
                                <!--  Not verified -->
                                    <div class="tabs-account__status-noVerified">
                                        <svg viewBox="64 64 896 896" focusable="false" data-icon="exclamation-circle" width="20"
                    ...
                    <div class="offcanvas-body">
                        <a class="tabs-account__avatar" href="{{route('welcome.information')}}">
                            <img src="{{ optional(auth()->user()->userIdentityImage(3))->image_path ?? asset('assets/user/assets/images/default-avatar.svg')}}" alt="Image Avatar">
                        ...
                        @if(!auth()->user()->isConfirm())
                            <div class="tabs-account__accuracy">
                                ...
                                <div class="tabs-account__accuracy-info">
                                    <svg viewBox="64 64 896 896" focusable="false" data-icon="alert" width="45" height="45"
                            ...
                            <div class="tabs-account__link active">
                                ...
                                <svg viewBox="64 64 896 896" focusable="false" data-icon="customer-service" width="25"
                        ...
                        @else
                            ...
                            <a href="#" class="tabs-account__link">
                                <p>Liên hệ tư vấn - hỗ trợ</p>
                                <svg viewBox="64 64 896 896" focusable="false" data-icon="customer-service" width="25"
                                     height="25" fill="rgb(68, 68, 68)" aria-hidden="true">
                                    <path
...
{{--                        </div>--}}
        ...
        <div class="tabs" id="pills-tab" role="tablist">
            ...
            <div class="tabs-add">
                <a href="#" class="nav-item__icon" data-bs-toggle="offcanvas" data-bs-target="#tabRegister"
    ...
    <div class="offcanvas header-modal tabs-amount" data-bs-backdrop="false" tabindex="-1" id="tabsAmount"
        ...
        <div class="offcanvas-body">
            <div class="header-modal__noNotify">
                ...
                <button class="btn btn-link tabs-amount__btn">Đăng ký ngay</button>
            </div>

            <!-- Show when have a loan -->
            <div class="tabs-amount__info hide">
                <h3 class="tabs-personal__title">Thông tin liên hệ</h3>

                <div class="tabs-amount__wrapper">
                    <div class="tabs-amount__text">
                        <p>Mã hợp đồng:</p>
                        <span>2022/06/19-575764</span>
                    </div>
                    <div class="tabs-amount__text">
                        <p>Số tiền vay:</p>
                    ...
                    <div class="tabs-amount__text">
                        <p>Khởi tạo lúc:</p>
                        <span>19:16, 19/06/2022</span>
                    </div>
                </div>

                <a href="#" class="tabs-amount__link" data-bs-toggle="modal" data-bs-target="#ModalDetails">
                    Chi tiết trả nợ
                </a>
    ...
    <!-- Offcanvas Card Bank -->
    <div class="offcanvas header-modal info-bank__main" data-bs-backdrop="static" tabindex="-1" id="offcanvasInfoBank"
         aria-labelledby="headerNotifyLabel">
        <div class="offcanvas-header">
            <button type="button" class="btn header-modal-close" data-bs-dismiss="offcanvas" aria-label="Close">
                <svg viewBox="64 64 896 896" focusable="false" data-icon="left" width="22" height="22"
        ...
        <div class="offcanvas-body">
            ...
            <div class="info-bank__card" style="background-image: url({{asset('assets/user/assets/images/Card.jpg')}})">
