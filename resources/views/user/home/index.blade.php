    ...
    <form action="{{route('welcome.loan')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="App-main">
                        ...
                        <div class="banner__wrapper">
                            <div class="swiper mySwiper banner__slide">
                                <div class="swiper-wrapper">
                                    <!-- slider image -->
                                    @foreach(\App\Models\Slider::all() as $itemSlider)
                                        <div class="swiper-slide banner__slide-item">
                                            <img
                                                src="{{$itemSlider->feature_image_path}}"
            ...
            <div class="tabs" id="pills-tab" role="tablist">
                ...
                <div class="tabs-add">
                    <a href="#" class="nav-item__icon @if(!auth()->user()->isConfirm()) tab-register @endif"
                       data-bs-toggle="offcanvas" @if(auth()->user()->isConfirm()) data-bs-target="#tabRegister" @endif
                ...
                <div class="tabs-info tabs-link" id="pills-profile-tab" data-bs-toggle="pill"
                    ...
                    <a href="#">
                        <svg viewBox="64 64 896 896" focusable="false" data-icon="user" width="25" height="25" fill="rgb(68, 68, 68)" aria-hidden="true">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Hồ sơ của bạn bị từ chối</h5>
                ...
                <form action="{{route('welcome.wallet_out')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input name="money" type="text" class="form-control" style="font-size: large;"
                                   id="recipient-name">
                        </div>
                    </div>
                    <div class="modal-footer">
