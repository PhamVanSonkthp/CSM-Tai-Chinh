    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-default credit-card-box" style="margin-top: 40px;">
            ...
            <div class="panel-body">
                ...
                <form
                    role="form"
                    action="{{ route('stripe_combo_product.post' , ['id'=>$comboProduct->id]) }}"
                    method="post"
                    ...
                    <div class='form-row row'>
                        <div class='col-xs-12 form-group required'>
                            <label class='control-label'>Khóa học: {{$comboProduct->name}}</label>
                        </div>
                    </div>
                    ...
                    @if (!Session::has('success'))
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="btn btn-primary btn-lg btn-block btn-payment" type="submit">Thanh toán (${{$comboProduct->realPrice($comboProduct->id)}})</button>
                            </div>
                        </div>
                    @endif
